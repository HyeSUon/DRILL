...
class IdleState:
    ...
    def do(boy):
        ...
        boy.timer -= 1
        boy.x += (boy.velocity + boy.brick_velocity) * game_framework.frame_time
        boy.x = clamp(boy.x_min_movement_range, boy.x, boy.x_max_movement_range)
        if boy.timer == 0:
...
class Boy:
    ...
    def __init__(self):
        ...
        self.dir = 1
        self.velocity = 0
        self.brick_velocity = 0
        self.frame = 0
        self.event_que = []
        self.cur_state = IdleState
        self.cur_state.enter(self, None)
        self.x_min_movement_range = 25
        self.x_max_movement_range = 1600 - 25
    def get_bb(self):
        # fill here
    ...
    def move(self, brick):
        self.y = brick.y + 50
        self.brick_velocity = brick.speed
        self.x_min_movement_range = brick.x - 90
        self.x_max_movement_range = brick.x + 90
